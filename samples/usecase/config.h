...
nlohmann::json makeAlgorithmConfig(
    const std::string& sharedObject, const std::string& name,
    const std::string& algorithmName, std::vector<std::string> modelPath,
    int maxBatchSize, std::vector<std::string> inputNodeName,
    std::vector<int> numInputs, std::vector<std::vector<int>> inputShape,
    std::vector<std::string> outputNodeName, std::vector<int> numOutputs,
    std::vector<std::vector<int>> outputShape, std::vector<float> threthold,
    int numClass, std::vector<std::string> labelNames = {}) {
...
nlohmann::json makeConnectConfig(int srcId, int srcPort, int dstId,
                                 int dstPort) {
...
nlohmann::json makeTrackerConfig(
    const std::string& sharedObject, const std::string& name,
    const std::string& algorithmName, int maxBatchSize, int topN, float iou,
    int maxAge, int minHins, int updateTimes, int baseTimes,
    float areaThresholds, float lowBound, float upBound, float qualityWidth,
    float qualityHeight, float margin, float maxScore, float latertalSide) {
