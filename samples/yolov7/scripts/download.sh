...
mkdir ../data/models
python3 -m dfss --url=open@sophgo.com:/sophon-stream/yolov7/BM1684X.tar.gz
tar -zxvf BM1684X.tar.gz
rm -rf BM1684X.tar.gz
mv ./BM1684X ../data/models/BM1684X

python3 -m dfss --url=open@sophgo.com:/sophon-stream/yolov7/BM1684.tar.gz
tar -zxvf BM1684.tar.gz
rm -rf BM1684.tar.gz
mv ./BM1684 ../data/models/BM1684

python3 -m dfss --url=open@sophgo.com:/sophon-stream/yolov7/BM1684X_tpukernel.tar.gz
tar -zxvf BM1684X_tpukernel.tar.gz
rm -rf BM1684X_tpukernel.tar.gz
mv ./BM1684X_tpukernel ../data/models/BM1684X_tpukernel

python3 -m dfss --url=open@sophgo.com:/sophon-stream/yolov7/BM1688.tar.gz
