...
└── BM1688
    ├── yolov8s_fp16_1b_2core.bmodel  # 使用TPU-MLIR编译，用于BM1688的FP16 双核 BModel，batch_size=1
    ├── yolov8s_fp16_1b.bmodel        # 使用TPU-MLIR编译，用于BM1688的FP16 单核 BModel，batch_size=1
    ├── yolov8s_fp16_4b_2core.bmodel  # 使用TPU-MLIR编译，用于BM1688的FP16 双核 BModel，batch_size=4
    ├── yolov8s_fp16_4b.bmodel        # 使用TPU-MLIR编译，用于BM1688的FP16 单核 BModel，batch_size=4
    ├── yolov8s_fp32_1b_2core.bmodel  # 使用TPU-MLIR编译，用于BM1688的FP32 双核 BModel，batch_size=1
    ├── yolov8s_fp32_1b.bmodel        # 使用TPU-MLIR编译，用于BM1688的FP32 单核 BModel，batch_size=1
    ├── yolov8s_fp32_4b_2core.bmodel  # 使用TPU-MLIR编译，用于BM1688的FP32 双核 BModel，batch_size=4
    ├── yolov8s_fp32_4b.bmodel        # 使用TPU-MLIR编译，用于BM1688的FP32 单核 BModel，batch_size=4
    ├── yolov8s_int8_1b_2core.bmodel  # 使用TPU-MLIR编译，用于BM1688的INT8 双核 BModel，batch_size=1
    ├── yolov8s_int8_1b.bmodel        # 使用TPU-MLIR编译，用于BM1688的INT8 单核 BModel，batch_size=1
    ├── yolov8s_int8_4b_2core.bmodel  # 使用TPU-MLIR编译，用于BM1688的INT8 双核 BModel，batch_size=4
    └── yolov8s_int8_4b.bmodel        # 使用TPU-MLIR编译，用于BM1688的INT8 单核 BModel，batch_size=4
```
...
测试视频`test_car_person_1080P.avi`，编译选项为Release模式，结果如下:
