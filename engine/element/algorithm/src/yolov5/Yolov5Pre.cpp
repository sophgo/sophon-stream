...
namespace sophon_stream
{
    namespace algorithm
    {
        namespace yolov5
        {
            void Yolov5Pre::initTensors(Yolov5SophgoContext &context, common::ObjectMetadatas &objectMetadatas)
            {
                /**
            ...
            common::ErrorCode Yolov5Pre::preProcess(Yolov5SophgoContext &context,
