...
#ifndef SOPHON_STREAM_ENGINE_FRAMEWORK_ELEMENT_FACTORY_H_
#define SOPHON_STREAM_ENGINE_FRAMEWORK_ELEMENT_FACTORY_H_
...
#endif  // SOPHON_STREAM_ENGINE_FRAMEWORK_ELEMENT_FACTORY_H_