...
/**
 * A class manages a lot of Elements, some of those Elements will connect with others.
 * A ElementManager is just a graph, a Element is just a node.
 */
...
public:
    ...
    /** 
     * Set callback to a Element in this ElementManager with a output port for receive data.
     ...
     */
    void setDataHandler(int elementId, 
                        int outputPort, 
        ...
        element->setDataHandler(outputPort, 
                               dataHandler);
    }
...
private:
    ...
    /** 
     * Element map of ElementManager, key is id of element, value is std::shared_ptr of framework::Element.
     */
    std::map<int/* elementId */, 
             std::shared_ptr<framework::Element> > mElementMap;

    /** 
     * Module map of ElementManager, key is id of module, value is std::shared_ptr of framework::ElementManager::Module.
     */
