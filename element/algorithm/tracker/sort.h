...
#ifndef SOPHON_STREAM_ELEMENT_TRACKER_SORT_SORT_H_
#define SOPHON_STREAM_ELEMENT_TRACKER_SORT_SORT_H_
...
class TrackerChannels {
 public:
   ...
   * @param[in]   fc    回调函数
   */
  void process(std::shared_ptr<common::ObjectMetadata> objectMetadatas,
...
#endif // SOPHON_STREAM_ELEMENT_TRACKER_SORT_SORT_H_