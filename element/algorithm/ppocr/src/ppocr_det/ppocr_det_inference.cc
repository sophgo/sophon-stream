...
Ppocr_detInference::mergeInputDeviceMem(std::shared_ptr<Ppocr_detContext> context,
...
std::shared_ptr<sophon_stream::common::bmTensors>
Ppocr_detInference::getOutputDeviceMem(std::shared_ptr<Ppocr_detContext> context) {
