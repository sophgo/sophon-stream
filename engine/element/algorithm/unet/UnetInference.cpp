 ...
 */
common::ErrorCode UnetInference::init(UnetSophgoContext& context) {
  UnetSophgoContext* pSophgoContext = &context;
  pSophgoContext->m_thresh = context.threthold;  // m_thresh[0] outThresh
  // pSophgoContext->m_outThreshold = pSophgoConetxt->m_thresh[0];
 ...
 */
common::ErrorCode UnetInference::predict(
