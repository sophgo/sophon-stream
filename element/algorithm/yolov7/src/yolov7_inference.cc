...
Yolov7Inference::mergeInputDeviceMem(std::shared_ptr<Yolov7Context> context,
...
std::shared_ptr<sophon_stream::common::bmTensors>
Yolov7Inference::getOutputDeviceMem(std::shared_ptr<Yolov7Context> context) {
...
void Yolov7Inference::splitOutputMemIntoObjectMetadatas(
