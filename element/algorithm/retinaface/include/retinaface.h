...
namespace retinaface {
  ...
  class Retinaface : public ::sophon_stream::framework::Element {
   public:
    ...
    static constexpr const char* CONFIG_INTERNAL_FACE_COUNT_FIELD = "max_face_count";
    static constexpr const char* CONFIG_INTERNAL_SCORE_THRESHOLD_FIELD = "score_threshold";
