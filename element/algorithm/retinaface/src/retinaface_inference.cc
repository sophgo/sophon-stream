...
RetinafaceInference::mergeInputDeviceMem(std::shared_ptr<RetinafaceContext> context,
...
std::shared_ptr<sophon_stream::common::bmTensors>
RetinafaceInference::getOutputDeviceMem(std::shared_ptr<RetinafaceContext> context) {
...
void RetinafaceInference::splitOutputMemIntoObjectMetadatas(
