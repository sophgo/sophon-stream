...
#ifndef SOPHON_STREAM_ELEMENT_TRACKER_SORT_QUALITY_CONTROL_H_
#define SOPHON_STREAM_ELEMENT_TRACKER_SORT_QUALITY_CONTROL_H_
...
#endif // SOPHON_STREAM_ELEMENT_TRACKER_SORT_QUALITY_CONTROL_H_