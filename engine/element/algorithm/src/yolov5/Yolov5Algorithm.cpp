 ...
 * @return 错误码
 */
common::ErrorCode Yolov5Algorithm::init(const std::string& side,
                                  int deviceId,
...
// REGISTER_ALGORITHM_API(Yolov5Algorithm::NAME, Yolov5Algorithm)
REGISTER_ALGORITHM_API("Yolov5", Yolov5Algorithm)
