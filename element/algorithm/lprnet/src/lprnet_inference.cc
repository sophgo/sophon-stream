...
LprnetInference::mergeInputDeviceMem(std::shared_ptr<LprnetContext> context,
...
std::shared_ptr<sophon_stream::common::bmTensors>
LprnetInference::getOutputDeviceMem(std::shared_ptr<LprnetContext> context) {
...
void LprnetInference::splitOutputMemIntoObjectMetadatas(
