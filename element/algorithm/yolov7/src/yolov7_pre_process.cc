...
float Yolov7PreProcess::get_aspect_scaled_ratio(int src_w, int src_h, int dst_w,
...
void Yolov7PreProcess::init(std::shared_ptr<Yolov7Context> context) {}

void Yolov7PreProcess::initTensors(std::shared_ptr<Yolov7Context> context,
...
common::ErrorCode Yolov7PreProcess::preProcess(
