 ...
 * @return 错误码
 */
common::ErrorCode TemplateAlgorithm::initInternal(const std::string& json) {
  ...
  do {
    ...
    mContext = std::make_shared<template ::TemplateSophgoContext>();
    mPreProcess = std::make_shared<template ::TemplatePre>();
    mInference = std::make_shared<template ::TemplateInference>();
    mPostProcess = std::make_shared<template ::TemplatePost>();
    ...
    // mContext->algorithmName = TemplateAlgorithm::Name;
    mContext->algorithmName = "Template";
 ...
 */
void TemplateAlgorithm::process(common::ObjectMetadatas& objectMetadatas) {
  common::ErrorCode errorCode = common::ErrorCode::SUCCESS;
  if (use_pre) {
 ...
 * 资源释放函数
 */
void TemplateAlgorithm::uninitInternal() {
...
common::ErrorCode TemplateAlgorithm::doWork() {
  common::ErrorCode errorCode = common::ErrorCode::SUCCESS;
...
common::ErrorCode TemplateAlgorithm::sendProcessedData() {
...
REGISTER_WORKER("Template", TemplateAlgorithm)
