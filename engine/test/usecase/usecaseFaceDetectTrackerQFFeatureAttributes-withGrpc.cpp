/**
@file usecaseFaceDetectTrackerQFFeatureAttributes-withGrpc.cpp
@brief 主程序
@details
    FaceDetectTrackerQFFeatureAttributes-withGrpc集成测试
...
/**
@brief FaceDetectTrackerQFFeatureAttributes-withGrpc集成测试函数入口
...
@UnitCase_Name
usecaseFaceDetectTrackerQFFeatureAttributes-withGrpc
...
//    engine.addGraph(graphConfigure.dump());
    ...
    = std::make_shared<std::thread>([&clientReader, &cv]() {
        ...
        IVS_INFO("~~~~~~~~~~~~~~~~~~~~~recieved result!, endofstream:{0}", report.object_metadata().packet().end_of_stream());
...
//                        }
    ...
    //decodeConfigure["url"] = "rtsp://lynxi:Lx20190812@192.168.17.10:554/Streaming/Channels/101?transportmode=unicast";
