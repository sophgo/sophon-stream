...
TEST(TestMultiAlgorithmGraph, MultiAlgorithmGraph) {
  ...
  for (int i = 0; i < MAX_GRAPH; i++) {
    ...
    istream.open("../usecase/json/yolotracker/Decoder.json");
    ...
    istream.open("../usecase/json/yolotracker/Pre.json");
    assert(istream.is_open());
    istream >> pre;
    pre.at("id") = PRE_ID;
    ...
    istream.open("../usecase/json/yolotracker/Action.json");
    assert(istream.is_open());
    istream >> action;
    ...
    istream.open("../usecase/json/yolotracker/Post.json");
    assert(istream.is_open());
    istream >> post;
    post.at("id") = POST_ID;
    ...
    istream.open("../usecase/json/yolotracker/Tracker.json");
    assert(istream.is_open());
    istream >> tracker;
