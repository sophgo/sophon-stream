...
Yolov8Inference::mergeInputDeviceMem(std::shared_ptr<Yolov8Context> context,
...
std::shared_ptr<sophon_stream::common::bmTensors>
Yolov8Inference::getOutputDeviceMem(std::shared_ptr<Yolov8Context> context) {
...
void Yolov8Inference::splitOutputMemIntoObjectMetadatas(
