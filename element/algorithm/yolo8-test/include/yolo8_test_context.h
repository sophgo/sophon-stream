...
#ifndef SOPHON_STREAM_ELEMENT_YOLO8_TEST_CONTEXT_H_
#define SOPHON_STREAM_ELEMENT_YOLO8_TEST_CONTEXT_H_
...
class Yolo8TestContext : public ::sophon_stream::element::Context {
 public:
  int deviceId;  // 设备ID
...
#endif  // SOPHON_STREAM_ELEMENT_YOLO8_TEST_CONTEXT_H_