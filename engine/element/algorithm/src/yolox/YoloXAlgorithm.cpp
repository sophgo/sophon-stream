 ...
 * @return 错误码
 */
common::ErrorCode YoloXAlgorithm::initInternal(const std::string& json) {
 ...
 * 资源释放函数
 */
void YoloXAlgorithm::uninitInternal() {
...
common::ErrorCode YoloXAlgorithm::doWork() {
    common::ErrorCode errorCode = common::ErrorCode::SUCCESS;
...
common::ErrorCode YoloXAlgorithm::sendProcessedData() {
...
REGISTER_WORKER("YoloX", YoloXAlgorithm)
