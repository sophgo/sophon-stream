...
const std::unordered_map<ErrorCode, std::string> ErrorCodeMap = {
    ...
    {ErrorCode::ERR_CUDA_INVALID_DEVICE, "ERR_CUDA_INVALID_DEVICE"},
    {ErrorCode::ERR_CUDA_INVALID_VALUE, "ERR_CUDA_INVALID_VALUE"},
    {ErrorCode::ERR_CUDA_MEMORY_ALLOCATION, "ERR_CUDA_MEMORY_ALLOCATION"},
    {ErrorCode::ERR_CUDA_INVALID_DEVICE_POINTER, "ERR_CUDA_INVALID_DEVICE_POINTER"},
    {ErrorCode::ERR_CUDA_INITIALIZATION, "ERR_CUDA_INITIALIZATION"},
    {ErrorCode::ERR_CUDA_INVALID_MEMCPY_DIRECTION, "ERR_CUDA_INVALID_MEMCPY_DIRECTION"},
    {ErrorCode::ERR_CUDA_INVALID_RESOURCE_HANDLE, "ERR_CUDA_INVALID_RESOURCE_HANDLE"},
    {ErrorCode::ERR_CUDA_DEVICE_IN_USE, "ERR_CUDA_DEVICE_IN_USE"},
...
static std::string ErrorCodeToString(ErrorCode code) {
  switch (code) {
    ...
    case ErrorCode::ERR_CUDA_INVALID_DEVICE:
      return "ERR_CUDA_INVALID_DEVICE";
    case ErrorCode::ERR_CUDA_INVALID_VALUE:
      return "ERR_CUDA_INVALID_VALUE";
    case ErrorCode::ERR_CUDA_MEMORY_ALLOCATION:
      return "ERR_CUDA_MEMORY_ALLOCATION";
    case ErrorCode::ERR_CUDA_INVALID_DEVICE_POINTER:
      return "ERR_CUDA_INVALID_DEVICE_POINTER";
    case ErrorCode::ERR_CUDA_INITIALIZATION:
      return "ERR_CUDA_INITIALIZATION";
    case ErrorCode::ERR_CUDA_INVALID_MEMCPY_DIRECTION:
      return "ERR_CUDA_INVALID_MEMCPY_DIRECTION";
    case ErrorCode::ERR_CUDA_INVALID_RESOURCE_HANDLE:
      return "ERR_CUDA_INVALID_RESOURCE_HANDLE";
    case ErrorCode::ERR_CUDA_DEVICE_IN_USE:
      return "ERR_CUDA_DEVICE_IN_USE";
