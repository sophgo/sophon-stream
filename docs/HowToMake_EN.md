...
2. `samples` will generate executable files in the `build` folder within the respective sample directories. For example, `samples/yolov5` will generate the `yolov5_demo` executable file under `samples/yolov5/build`.
