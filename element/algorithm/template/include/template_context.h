...
#ifndef SOPHON_STREAM_ELEMENT_TEMPLATE_CONTEXT_H_
#define SOPHON_STREAM_ELEMENT_TEMPLATE_CONTEXT_H_
...
class TemplateContext : public ::sophon_stream::framework::Context {
 public:
  int deviceId;  // 设备ID
...
#endif  // SOPHON_STREAM_ELEMENT_TEMPLATE_CONTEXT_H_