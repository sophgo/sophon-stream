...
#ifndef SOPHON_STREAM_ELEMENT_UNET_UNET_SOPHGOCONTEXT_H_
#define SOPHON_STREAM_ELEMENT_UNET_UNET_SOPHGOCONTEXT_H_
...
#endif // SOPHON_STREAM_ELEMENT_UNET_UNET_SOPHGOCONTEXT_H_