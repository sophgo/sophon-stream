...
class Algorithms:
    def yolov5_build_config(self,algorithm_name,stream_path,data,port,i,is_single_process):
        return yolov5.yolov5_build_config(algorithm_name,stream_path,data,port,i,is_single_process)
    ...
    def tripwire_build_config(self,algorithm_name,stream_path,data,port,i,is_single_process):
        return tripwire.tripwire_build_config(algorithm_name,stream_path,data,port,i,is_single_process)
    ...
    def license_area_intrusion_build_config(self,algorithm_name,stream_path,data,port,i,is_single_process):
        return license_area_intrusion.license_area_intrusion_build_config(algorithm_name,stream_path,data,port,i,is_single_process)
