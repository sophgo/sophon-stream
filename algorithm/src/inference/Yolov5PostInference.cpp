...
namespace sophon_stream
{
    namespace algorithm
    {
        namespace inference
        {
            ...
            Yolov5PostInference::~Yolov5PostInference()
            {
            }
             ...
             */
            common::ErrorCode Yolov5PostInference::init(algorithm::Context &context)
            {
                context::SophgoContext *pSophgoContext = dynamic_cast<context::SophgoContext *>(&context);

                // has done in Inference::init
                ...
                // if (pSophgoContext->use_tpu_kernel == true)
                // {
            ...
            void Yolov5PostInference::uninit()
            {
            }
