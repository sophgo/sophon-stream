...
|设备|路数|算法线程数|CPU利用率(%)|系统内存(M)|系统内存峰>值(M)|TPU利用率(%)|设备内存(M)|设备内存峰值(M)|平均FPS|峰>值FPS|
|----|----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
|SE7|8|8-8-8|747.49|173.10|175.50|78.62|1933.97|2008.00|82.06|91.45|
|SE5-16|4|4-4-4|571.45|100.10|101.43|99.78|703.38|743.00|61.16|68.92|
|SE5-8|3|3-3-3|324.26|80.91|82.16|99.68|522.47|553.00|36.14|39.37|
> **测试说明**：
