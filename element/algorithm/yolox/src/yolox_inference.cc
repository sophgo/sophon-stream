...
YoloxInference::mergeInputDeviceMem(std::shared_ptr<YoloxContext> context,
...
std::shared_ptr<sophon_stream::common::bmTensors>
YoloxInference::getOutputDeviceMem(std::shared_ptr<YoloxContext> context) {
...
void YoloxInference::splitOutputMemIntoObjectMetadatas(
