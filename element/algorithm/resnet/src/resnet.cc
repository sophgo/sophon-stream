...
common::ErrorCode ResNet::initContext(const std::string& json) {
  ...
  do {
    ...
    mContext->converto_attr.alpha_0 = 1 / mContext->stdd[0] * input_scale;
    mContext->converto_attr.alpha_1 = 1 / mContext->stdd[1] * input_scale;
    mContext->converto_attr.alpha_2 = 1 / mContext->stdd[2] * input_scale;
