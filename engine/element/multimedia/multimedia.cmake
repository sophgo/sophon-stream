...
if (${TARGET_ARCH} STREQUAL "pcie")
    ...
    add_library(multiMediaApi SHARED
        element/multimedia/src/MultiMediaFactorySelector.cpp
        element/multimedia/src/MultiMedia.cpp
        element/multimedia/src/context/SophgoContext.cpp
        element/multimedia/src/process/SophgoDecode.cpp
        element/multimedia/src/factory/SophgoDecodeFactory.cpp
        ../share/common/ff_decode.cpp
        )
    target_link_libraries(multiMediaApi ${FFMPEG_LIBS} 
...
elseif(${TARGET_ARCH} STREQUAL "soc")
    ...
    target_link_libraries(multiMediaApi ${FFMPEG_LIBS} 
        ${OpenCV_LIBS} ${BM_LIBS} ${JPU_LIBS} ${the_libbmlib.so} ${the_libbmrt.so} ${the_libbmcv.so} -lpthread)
