...
class PreModuleElement : public framework::Element {
public:
    /**
     ...
     */
    ~PreModuleElement() override;

    PreModuleElement(const PreModuleElement&) = delete;
    PreModuleElement& operator =(const PreModuleElement&) = delete;
    PreModuleElement(PreModuleElement&&) = default;
    PreModuleElement& operator =(PreModuleElement&&) = default;

    static constexpr int BEGIN_WORKER_ID = 1000;
    static int gCurrentElementId;

    static constexpr const char* NAME = "pre_module_element";
